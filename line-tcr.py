...
cl = LINETCR.LINE()
cl.login(token='ElfRhZxJinE3VRp2gpx6.8c72ir4ebAnfw7s7cdExTG.XQYZeXvkNpU8cXyvhJH8YRYhfWOh0/1yK9cudx+jMB4=')
cl.loginResult()
...
helpMessage ="""¤¤¤¤ Bot By : Muhammad Irfan ¤¤¤¤
¤ Id︎
¤ Mid
¤ Me︎
¤ TL︎:「Text」
...
admin=["uf02ef6211e0405a3455bb4bb083797b6"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner. Instagram : @irfan.m__",
    "lang":"JP",
    "comment":"Owner. Instagram : @irfan.m__",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
